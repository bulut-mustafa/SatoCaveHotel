...
export function ActivitiesSection({ dict, lang }: { dict: any, lang: string }) {
    ...
    const activities = [
        ...
        { id: 'red_tour', data: dict.red_tour, video: '/videos/compressed/uchisar-castle.mp4', poster: '/images/uchisar-castle.webp', image: '/images/uchisar-castle.webp', hoverOnly: true },

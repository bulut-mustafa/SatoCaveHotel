  ...
  return [
    {
      ...
      images: Array.from({ length: 15 }, (_, i) => `/images/rooms/Room-1/room-1-${i + 1}.jpg`),
    ...
    },
    {
      ...
      images: Array.from({ length: 16 }, (_, i) => `/images/rooms/Room-2/room-2-${i + 1}.jpg`),
    ...
    },
    {
      ...
      capacity: 3,
      bedType: "Double Bed",
      image: "/images/rooms/Room-3/room-3-3.jpg",
      images: Array.from({ length: 11 }, (_, i) => `/images/rooms/Room-3/room-3-${i + 1}.jpg`),
    ...
    },
    {
      ...
      capacity: 2,
      bedType: "Double Bed",
      image: "/images/rooms/Room-4/room-4-2.jpg",
      images: Array.from({ length: 10 }, (_, i) => `/images/rooms/Room-4/room-4-${i + 1}.jpg`),
    ...
    },
    {
      ...
      images: Array.from({ length: 15 }, (_, i) => `/images/rooms/Room-5/room-5-${i + 1}.jpg`),
    ...
    },
    {
      ...
      size: "40 sqm",
      capacity: 3,
      bedType: "Round Bed + Single Bed",
      image: "/images/rooms/Room-6/room-6-2.jpg",
      images: Array.from({ length: 11 }, (_, i) => `/images/rooms/Room-6/room-6-${i + 1}.jpg`),
    ...
    },
    {
      ...
      image: "/images/rooms/Room-7/room-7-2.jpg",
      images: Array.from({ length: 19 }, (_, i) => `/images/rooms/Room-7/room-7-${i + 1}.jpg`),
    ...
    },
    {
      ...
      capacity: 2,
      bedType: "Double Bed",
      image: "/images/rooms/Room-8/room-8-6.jpg",
      images: Array.from({ length: 15 }, (_, i) => `/images/rooms/Room-8/room-8-${i + 1}.jpg`),
